...
def process_media(
    ...
    if tagged:
        ...
        # Tag NAME is authoritative (poster's intent). When the model produced
        # canonical coords (it normally does — for matching tags they echo the
        # input, for conflicting tags they correct to the named place), use
        # those. Fall back to instagrapi's coords only for hyper-local tags
        # the model can't pin precisely.
