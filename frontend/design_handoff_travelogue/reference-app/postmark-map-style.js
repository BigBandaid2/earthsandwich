// Travelogue — Google Maps style array, "Postmark" sepia theme.
// Pass to the map via the `styles` option (vanilla JS Maps API) or the
// <Map mapId> / styles prop in @vis.gl/react-google-maps.
//   import postmarkMapStyle from './postmark-map-style';
//   <Map defaultZoom={3} styles={postmarkMapStyle} disableDefaultUI />
// Tuned to design tokens: land #E7DCC4, water #F4ECD9, ink #6C6253.

const postmarkMapStyle = [
...
if (typeof module !== 'undefined') module.exports = postmarkMapStyle;
